...
private TextView dianji2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wodexiaomai);
        dian();
        tiao();
        tiao2();
    }
    ...
    public void dian(){
        ...
        have_layout = (RelativeLayout) findViewById(R.id.have_layout);
    ...
    public  void tiao(){
        dianji2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Five.this, Dengluatvt.class);
    ...
    public  void tiao2(){
        sz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Five.this, Shezhijiemian.class);
                startActivity(intent);
            }
        });
